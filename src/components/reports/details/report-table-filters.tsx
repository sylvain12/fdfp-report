...
export default function ReportTablesFilters() {
  return (
    <div className="report-filter-container flex items-end justify-between gap-[4rem] bg-transparent mt-[3rem] px-0 pb-10 border-b-none max-xl:flex-col max-xl:items-start max-xl:gap-[3rem]">
